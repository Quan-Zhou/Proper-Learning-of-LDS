...
%% load Y
Y=readmatrix('ncpop300_ydata.csv',Range=[2 2]);
...
data = readmatrix('ncpop300.csv',Range=[2 2]);
...
%%
save SysIden_workspace
writecell(yData,'ncpop300_mean_plot.csv')
writecell(errors,'ncpop300_std_plot.csv')
