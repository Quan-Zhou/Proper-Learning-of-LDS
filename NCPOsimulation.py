# -*- coding: utf-8 -*-
"""
Created on Thu Jan  9 09:06:50 2020

@author: zhouq
"""

import sys
sys.path.append('C:\\Users\\zhouq\\.spyder-py3\\OnlineLDS-master')
...
# length of  estimation data and required relaxation level. 
            ...
            nrmse_sim = 1-math.sqrt(sdp[sum((Y[i]-f[i])**2 for i in range(T))])/math.sqrt(sum((Y[i]-np.mean(Y))**2 for i in range(T)))
...
# Collecting the nrmse value for each experiment
